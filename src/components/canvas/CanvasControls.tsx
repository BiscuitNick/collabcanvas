...
const CanvasControls: React.FC = () => {
  ...
  return (
    <div className="flex items-center gap-4 p-4 bg-gray-100 border-b border-gray-300 flex-wrap">
      {/* Zoom Controls */}
      ...
      <div className="text-sm text-gray-600 ml-auto">
        <span className="hidden sm:inline">Pan: Click and drag • Zoom: Mouse wheel • </span>
        <span>Keyboard: Ctrl+/- or Escape to reset</span>
      </div>
    </div>
  )
}
